...
public class ModifierCategorie extends JFrame {
    ...
    public ModifierCategorie() throws HeadlessException {
        super("Modifier cette catégorie");
        ...
        confirm.addActionListener(e -> {
            ...
            {   int res = JOptionPane.showConfirmDialog(this,
                ...
                if(res == 0) {
                    ...
                    gest_catalog.modifierCategorie(categorie);
        ...
        tnom.addKeyListener(new ModifierCategorie.EcouteurClavierAdapter());
        tdesc.addKeyListener(new ModifierCategorie.EcouteurClavierAdapter());
